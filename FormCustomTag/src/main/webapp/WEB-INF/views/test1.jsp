...
<body>
	...
	<form action="result" method="post">
		이름: <input type="text" name="user_name" value="${requestScope.userDataBean.user_name }"> <br> 아이디: <input
			type="text" name="user_id" value="${requestScope.userDataBean.user_id }"
		><br> 비밀번호: <input type="password" name="user_pw" value="${requestScope.userDataBean.user_pw}"><br>
